...
## 5. Debug browser and app routing

For agent-driven browser work, use `agent-workspace-linux` so the browser belongs to an isolated hidden X11 workspace instead of a persistent corporate browser profile.
